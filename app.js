    ...
    data.forEach(aiHub => {
        ...
        div.innerHTML = `
                <div class="card p-3 mainCard">
                    <img src="${image ? image : './img/error.gif'}" class="card-img-top rounded" alt="...">
                    <div class="card-body">
                        ...
                        <div>
                            <button onclick="CardDetails('${id}')" class="right-arrow" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa-solid fa-arrow-right text-danger"></i></button>
                        </div>
                    </div>
                </div>
        `
